class CuentaBancaria
    ...
    def initialize(nombre_de_usuario,numero_de_cuenta,vip=0)#constructor
        @nombre_de_usuario=nombre_de_usuario
        @vip=vip
        begin 
            @numero_de_cuenta=numero_de_cuenta
            raise RangeError 'El número de cuenta debe tener 8 digitos' if numero_de_cuenta.digits.count != 8
        rescue
            @numero_de_cuenta='-----'
    ...
    def numero_de_cuenta
        "#{@vip}-#{@numero_de_cuenta}" #return no es necesario
    end
end 
...
puts cuenta3 = CuentaBancaria.new('persona3', 12345678).nombre_de_usuario